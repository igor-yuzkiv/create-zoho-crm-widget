...
`;
function isDirEmpty(projectDirectory) {
...
function copyTemplate(template, targetPath) {
...
async function main() {
    ...
    if (!isDirEmpty(targetPath)) {
        return cancel(`The target directory "${targetDir}" is not empty. Please choose an empty directory or a different project name.`);
    }
